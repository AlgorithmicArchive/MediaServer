          ...
          while (1) switch (_context.p = _context.n) {
            ...
            case 1:
              ...
              if (((_response$data$type = response.data.type) === null || _response$data$type === void 0 ? void 0 : _response$data$type.toLowerCase()) === "movie") {
                ...
                if (movieFile) setCurrentVideo(setCurrentVideo("".concat(response.data.basePath.replace(/\/+$/, ""), "/").concat(movieFile.streamUrl)));
                ...
                setCurrentVideo("".concat(response.data.basePath, "/").concat(firstEpisode.streamUrl));
              } else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("64cd6904c41bc20516b6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.e23eb19ea8433787d2ec.hot-update.js.map