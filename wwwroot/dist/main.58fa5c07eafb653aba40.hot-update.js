...
function MediaDetailPage() {
  ...
  function _getStream() {
    _getStream = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(filePath) {
      var videoUrl, _err$response2, _t2;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            _context2.p = 0;
            setLoading(true);
            videoUrl = "http://localhost:5029/User/StreamMedia?filePath=".concat(encodeURIComponent(filePath)); // const response = await axiosInstance.get("/User/StreamMedia", {
            //   params: { filePath },
            //   responseType: "blob",
            //   timeout: 120000,
            // });
          ...
          case 1:
            ...
            setError(((_err$response2 = _t2.response) === null || _err$response2 === void 0 ? void 0 : _err$response2.status) === 404 ? "Video file not found" : _t2.message === "Empty video stream received" ? "Invalid video stream" : "Failed to stream video. Try again or contact support.");
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4c7aee34365f4b695933")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.58fa5c07eafb653aba40.hot-update.js.map