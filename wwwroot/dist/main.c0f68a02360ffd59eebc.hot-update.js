...
function MediaDetailPage() {
  ...
  function _getStream() {
    _getStream = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(filePath) {
      var response, videoUrl, _err$response2, _t2;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            ...
            setLoading(true);
            _context2.n = 1;
            return _axiosConfig__WEBPACK_IMPORTED_MODULE_2__["default"].get("/User/StreamMedia", {
              params: {
                filePath: filePath
              },
              responseType: "blob",
          ...
          case 2:
            videoUrl = URL.createObjectURL(response.data); // Create blob URL
            setCurrentVideo(videoUrl);
            return _context2.a(2, videoUrl);
          case 3:
            _context2.p = 3;
            _t2 = _context2.v;
            console.error("Streaming error:", _t2);
            setError(((_err$response2 = _t2.response) === null || _err$response2 === void 0 ? void 0 : _err$response2.status) === 404 ? "Video file not found" : _t2.message === "Empty video stream received" ? "Invalid video stream" : "Failed to stream video: ".concat(_t2.message, ". Please try again or contact support."));
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 1:
              ...
              _context.n = 2;
              return getStream(movieFile.streamUrl);
            case 2:
              _context.n = 6;
              break;
            case 3:
              ...
              _context.n = 4;
              return getStream(firstEpisode.streamUrl);
            case 4:
              _context.n = 6;
              break;
            case 5:
            ...
            case 7:
              _context.p = 7;
              _t = _context.v;
              setError(((_err$response = _t.response) === null || _err$response === void 0 ? void 0 : _err$response.status) === 404 ? "Media not found" : "Failed to fetch media details: ".concat(_t.message));
            case 8:
              _context.p = 8;
              setLoading(false);
              return _context.f(8);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    return function () {
      if (currentVideo) {
        ...
        setCurrentVideo(""); // Clear currentVideo to avoid stale URLs
      }
    };
  }, [currentVideo]);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    onError: function onError(e) {
      ...
      setError("Failed to play video. Please try again or contact support.");
    }
  }, "Your browser does not support the video tag.")) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_4__["default"], {
    sx: {
      mb: 4
    }
  }, "Loading video..."), ((_media$type = media.type) === null || _media$type === void 0 ? void 0 : _media$type.toLowerCase()) === "series" && ((_media$seasons = media.seasons) === null || _media$seasons === void 0 ? void 0 : _media$seasons.length) > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_5__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_4__["default"], {
    variant: "h4",
    gutterBottom: true
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c6b27fdfc82faafa5e2f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.c0f68a02360ffd59eebc.hot-update.js.map