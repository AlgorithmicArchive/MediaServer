...
function MediaDetailPage() {
  ...
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    ...
    setSelectedSeason = _useState0[1]; // Default to first season
            ...
            case 1:
              ...
              if (((_response$data$type = response.data.type) === null || _response$data$type === void 0 ? void 0 : _response$data$type.toLowerCase()) === "movie") {
                ...
                if (movieFile) {
                  ...
                  setError("No playable content available for this movie");
                }
                ...
                setError("No playable content available for this series");
              }
              _context.n = 3;
              break;
            case 2:
  ...
  var handleEpisodeClick = function handleEpisodeClick(streamUrl) {
  ...
  var handleSeasonChange = function handleSeasonChange(event) {
    ...
    var season = media.seasons[event.target.value];
    if (((_season$episodes = season.episodes) === null || _season$episodes === void 0 ? void 0 : _season$episodes.length) > 0) {
      setCurrentVideo("/User/StreamMedia?filePath=".concat(encodeURIComponent(season.episodes[0].streamUrl)));
    }
  };
  if (loading) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  }, "Your browser does not support the video tag.")), ((_media$type = media.type) === null || _media$type === void 0 ? void 0 : _media$type.toLowerCase()) === "series" && ((_media$seasons = media.seasons) === null || _media$seasons === void 0 ? void 0 : _media$seasons.length) > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_3__["default"], {
    sx: {
      mb: 4
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_10__["default"], {
      ...
      onClick: function onClick() {
        return handleEpisodeClick(ep.streamUrl);
      },
      fullWidth: true,
      sx: {
        py: 1.5,
  ...
  })))), ((_media$type2 = media.type) === null || _media$type2 === void 0 ? void 0 : _media$type2.toLowerCase()) === "movie" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_3__["default"], {
    sx: {
      mt: 3,
      maxWidth: "800px"
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a83a6a77deac811ea339")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.ede19f51ec6a81f51a72.hot-update.js.map